...
API_ID = int(environ.get('API_ID', '3256301'))
API_HASH = environ.get('API_HASH', 'e1c0e7109fc085b061784ceb4dd97bad')
BOT_TOKEN = environ.get('BOT_TOKEN', "6843349739:AAF6Ymf-7_WsyNQ7uAgOSeN9E50Dk6lfHnE")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1172680877').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001560302374').split()] #Channel id for auto indexing ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '2349519187'))
